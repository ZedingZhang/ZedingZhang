...
|---|---|---|
| Recursive research and improvement | [Ya](https://github.com/ZedingZhang/ya-agent) | User-approved SEA memory updates, ICM targeted exploration, and bounded ToA multi-agent research |
