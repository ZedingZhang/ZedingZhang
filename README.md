...
|---|---|---|
| [RepoAirlock](https://github.com/ZedingZhang/repoairlock) | Safety-oriented execution harness for coding agents: Docker isolation, policy enforcement, audit trails, patch replay, HTML reports | v0.1.0-alpha candidate. Tier 0 stabilization in progress. |
